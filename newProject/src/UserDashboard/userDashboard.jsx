...
const UserDashboard = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            try {
                const response = await axios.get('http://localhost:8080/user/' + sessionStorage.getItem('userName'));
    ...
    const handleSaveClick = async () => {
        try {
            ...
            // Make a request to save only the changed data
        ...
        <div className="max-w-6xl mx-auto mt-10 px-8 py-10 bg-white rounded-lg shadow-lg">
            <div className="flex">
                <div className="w-1/4 bg-gradient-to-br from-blue-600 to-blue-400 rounded-lg p-6 shadow-lg text-white">
                    <h2 className="text-3xl font-bold mb-8">Welcome {sessionStorage.getItem('userName')}</h2>
